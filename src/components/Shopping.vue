    ...
    <div class="shopping-content">
      <div class="shopping-content-list">
        ...
        >
          ...
          <div class="shopping-content-list-item-desc">
            <p
              class="shopping-content-list-item-desc-name"
              :class="{'shopping-content-list-item-desc-name-hint' : !item.isHave}"
            >
            ...
            <div class="shopping-content-list-item-desc-data">
              ...
              <goods-number-manager
                :defaultNumber="item.number"
                @onNumberChange="onNumberChange(arguments, item, index)"
              ></goods-number-manager>
            </div>
          </div>
        </div>
      ...
      <div class="shopping-content-total">
        ...
        <div class="shopping-content-total-check">
          <img
            :src="checkIcon(totalDatas.isAll)"
...
export default {
  ...
  data: function () {
    return {
      shoppingDatas: this.$store.state.goods.shoppingDatas,
      totalDatas: {
        isAll: false,
        totalPrice: 0,
        goodsNumber: 0
  ...
  methods: {
    ...
    onNumberChange: function ($arguments, item, index) {
      ...
      if (number === 0) {
        this.$store.commit('delShoppingData', index)
